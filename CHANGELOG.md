...
- Diagnostics/Subagents: reconcile heartbeat `active` counts against the live subagent run registry so finished child sessions no longer linger as active or `stuck` after their work has already ended.
